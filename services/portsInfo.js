...
function checkPort(host, port, options = {}) {
...
export async function getPortsInfo(host, options = {}) {
    const start = Date.now();

    const results = await Promise.all(COMMON_PORTS.map(p => checkPort(host, p, options)));
